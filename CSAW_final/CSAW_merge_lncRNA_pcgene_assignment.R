...
in.dir1 <- "./Output/CSAW_slidewindow_assign_final/pcgenes/"




####Input assignment results for lncRNA
in.dir2 <- "./Output/CSAW_slidewindow_assign_final/lncRNA/"
...
####Output directory
out.dir <- "./Output/CSAW_slidewindow_assign_final/pcgenes_lncRNA_merge/"
