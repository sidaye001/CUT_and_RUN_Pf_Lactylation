...
broad.peaks.file1<-  "./Output/DBA_edgeR_Output/broad/"
...
out.dir <- "./Output/DBA_edgeR_assign/"
...
for (i in 1:n){
  ...
  genic.peaks2_final <- genic.peaks2%>%transmute(Chr = V1, str = V2, end = V3, binding_width = V4, strand=V5, Conc=V6, Conc_8mM=V7, Conc_UNT=V8,
                                                 Fold=V9, p.value=V10, FDR=V11, binding_ID=V12,GeneID = covered_genes, overlapped=V3-V2,num=num,Category = 'Covered more than one gene')
  ...
  nongenic.promoter.peaks_final <- nongenic.promoter.peaks%>%transmute(Chr = V1, str = V2, end = V3, binding_width = V4, strand=V5, Conc=V6, Conc_8mM=V7, Conc_UNT=V8,
                                                                       Fold=V9, p.value=V10, FDR=V11, binding_ID=V12, GeneID = V16, overlapped=V19,num=1,Category = Category)
  ...
  if (nrow(intergenic.peaks.genes.dist)==0){
    ...
    intergenic.peaks_final <- intergenic.peaks.genes.dist2 %>% 
      transmute(Chr = V1, str = V2, end = V3, binding_width = V4, strand=V5, Conc=V6, Conc_8mM=V7, Conc_UNT=V8,
                Fold=V9, p.value=V10, FDR=V11, binding_ID=V12,GeneID = V28, overlapped=V3-V2,num=num,Category = 'Intergenic')
  ...
  if(nrow(genic.peaks1)==0){
    ...
    genic.peaks1_final2 <- genic.peaks1_final %>%
      transmute(Chr = V1, str = V2, end = V3, binding_width = V4, strand=V5, Conc=V6, Conc_8mM=V7, Conc_UNT=V8,
                Fold=V9, p.value=V10, FDR=V11, binding_ID=V12, GeneID = V26, overlapped=V29,num=1,Category = Category)
  ...
  write.xlsx(all.peaks, paste0(out.dir,sample_name[i],"_allpeaks_broad.xlsx"))
