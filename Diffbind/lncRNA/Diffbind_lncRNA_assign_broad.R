...
broad.peaks.file1<-  "/Users/sidaye/Documents/R/Cut_Run_Manish/Manish_lac/Output/DBA_edgeR_Output/broad/"
...
out.dir <- "/Users/sidaye/Documents/R/Cut_Run_Manish/Manish_lac/Output/DBA_edgeR_assign_lncRNA/broad/"
...
for (i in 1:n){
  ...
  genic.peaks2_final <- genic.peaks2%>%transmute(Chr = V1, str = V2, end = V3, binding_width = V4, strand=V5, Conc=V6, Conc_8mM=V7, Conc_UNT=V8,
                                                 Fold=V9, p.value=V10, FDR=V11, binding_ID=V12,GeneID = covered_genes, overlapped=V3-V2,num=num,Category = 'Covered more than one lncRNA')
