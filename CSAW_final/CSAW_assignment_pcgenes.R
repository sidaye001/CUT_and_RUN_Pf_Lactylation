...
broad.peaks.file1<-  "./Input/CSAW_slidewindow_final/differential_binding/"
...
out.dir <- "./Output/CSAW_slidewindow_assign_final/pcgenes/"
...
for (i in 1:n){
  ...
  sample_name <- sub("_CSAW.*", "", count.files1[i])
  ...
  write.xlsx(all.peaks, paste0(out.dir,sample_name,"_differentialbinding_assigned.xlsx"))
